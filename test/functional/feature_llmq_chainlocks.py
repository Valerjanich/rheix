...
from test_framework.test_framework import RheixTestFramework
...
class LLMQChainLocksTest(RheixTestFramework):
    def set_test_params(self):
        self.set_rheix_test_params(6, 5, fast_dip3_enforcement=True)
