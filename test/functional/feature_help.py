...
"""Verify that starting rheixd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start rheixd with -h for help text")
        ...
        self.log.info("Start rheixd with -version for version information")
