Contributing to Rheix Core
============================

The Rheix Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/rheixverse/rheix/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Rheix Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Rheix
Network Protocol consensus changes.

Whether a pull request is merged into Rheix Core rests with the project merge
...
Patches that change Rheix consensus rules are considerably more involved than
...
Where a patch set proposes to change the Rheix consensus, it must have been
...
The review process is normally fairly responsive on the Rheix Core repository, however
...
The project leader is the release manager for each Rheix Core release.
