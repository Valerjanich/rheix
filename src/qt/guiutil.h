...
/** Utility functions used by the Rheix Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "rheix:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load rheix specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a rheix specific theme is activated (light/dark).*/
