...
/* RheixGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* RheixGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Rheix"
#define QAPP_ORG_DOMAIN "rheixverse.com"
#define QAPP_APP_NAME_DEFAULT "Rheix-Qt"
#define QAPP_APP_NAME_TESTNET "Rheix-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Rheix-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Rheix-Qt-regtest"
