...
//! Interface for the src/evo part of a rheix node (rheixd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a rheix node (rheixd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a rheix node (rheixd process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a rheix node (rheixd process).
class Node
{
public:
    virtual ~Node() {}
