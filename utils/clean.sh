...
rm -f src/config/rheix-config.h
...
rm -rf test_bitcoin.coverage/ rheix-gtest.coverage/ total.coverage/
...
clean_exe src/rheix-cli
clean_exe src/rheixd
clean_exe src/rheix-gtest
clean_exe src/rheix-tx
clean_exe src/test/test_rheix
clean_exe src/test/test_rheix_fuzzy
...
clean_dep . src/config/rheix-config.h.in
