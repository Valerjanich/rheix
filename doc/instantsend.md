...
This mechanism has been integrated into Bitcore-Node-Rheix which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/rheixverse/insight-api-rheix#web-socket-api](https://github.com/rheixverse/insight-api-rheix#web-socket-api)
* API: [https://github.com/rheixverse/insight-api-rheix#instantsend-transactions](https://github.com/rheixverse/insight-api-rheix#instantsend-transactions)
