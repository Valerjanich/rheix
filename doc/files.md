...
* rheix.conf: contains configuration settings for rheixd or rheix-qt
* rheixd.pid: stores the process id of rheixd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by rheixd or rheix-qt
